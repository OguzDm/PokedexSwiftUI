...
class PokemonSprites: Codable {
    ...
    init(backDefault: String, backFemale: JSONNull?, backShiny: String, backShinyFemale: JSONNull?, frontDefault: String, frontFemale: JSONNull?, frontShiny: String, frontShinyFemale: JSONNull?, other: OtherSprites?, versions: Versions?, animated: PokemonSprites?) {
...
struct OtherSprites: Codable {
    ...
    let officialArtwork: OfficialArt
